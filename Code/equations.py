...
def gather(gb, equation_manager, iterate=False):
    ...
    # NOTE: Numerous reasons can cause "need a csr matrix" error-message.
    # If you get one, some debugging ideas:
    #   - test on a unfractured grid    
    #   - ensure all mpfa-related discretization matrices are csr
  
    # If non of these work, either use tpfa or contact me
